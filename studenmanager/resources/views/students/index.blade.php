    ...
    <div class="container">
        <div class="header">
            <div>
                ...
                <p class="hint">Bảng dữ liệu hiển thị theo giao diện Apple Liquid Glass.</p>
            </div>
        ...
        <form method="GET" action="/students" style="margin: 0 0 14px; display:flex; gap:8px; align-items: center; flex-wrap: wrap;">
        ...
        <div class="table-wrap">
            <table>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td class="empty" colspan="5">Chưa có sinh viên nào.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        @if ($students->hasPages())
            <div style="text-align:center; margin-top:12px;">{{ $students->links() }}</div>
        @endif
    </div>
</body>
</html>
